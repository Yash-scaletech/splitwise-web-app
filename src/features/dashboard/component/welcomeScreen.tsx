	...
	return (
		<div className="welcome-screen flex align-items--center justify-content--center">
			<div className="text--center">
				<h1 className="font-size--40 mb--20">Welcome to Splitwise</h1>
				<p className="description font-size--18 mb--30">
				...
				<button
					className="start-button text--white font-size--browser-default pointer border-radius--sm"
